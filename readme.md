...
A lightweight multi-user chat server built using Node.js and the built-in `net` module. It allows users to connect, log in, and chat with each other in real time over TCP—no frameworks or databases used.
